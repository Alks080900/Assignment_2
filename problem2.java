...
public class problem2 {
    public static void main(String[] args) {
        ...
        for (String record : delimeters) {
            //Added a new String of array to store the new split of strings
            String [] productID = record.split(",");

            //Checking if it has been separated
            //System.out.println(Arrays.toString(productID));

            //Accessing the index position of zero(0) to get the productId
